...
bool mencari(const char* kata) {		//bool untuk fungsi true atau false deklarasi fungsi mencari yang menerima satu parameter
    ...
    // Check horizontally dari kiri ke kanan
    ...
    // Check horizontal kanan ke kiri
    for (int i = 0; i <= 24; i++) {
        for (int j = 0; j < 24; j++) {
            bool ketemu = true;
    ...
    // Check vertically atas ke bawah
    for (int i = 0; i <= 24; i++) {
        for (int j = 0; j < 24; j++) {
            bool ketemu = true;
            for (int k = 0; k < kataLen; k++) {
    ...
    // Check vertically bawah ke atas
    for (int i = 0; i <= 24; i++) {
        for (int j = 0; j < 24; j++) {
            bool ketemu = true;
            for (int k = 0; k < kataLen; k++) {
...
int main() {
	...
	cout << endl << "Ingin mencoba lagi ?(y/n) ";    //menampilkan pilihan "ingin mencoba lagi? "
  	cin>>lagi;										//akan menyimpan nilai atau string ke variable lagi
